...
export function AssetTable({ isClientView = false, onSelectProduct }: AssetTableProps) {
  ...
  const { products, pinnedProducts, togglePin } = useDashboardStore()
              ...
              <Tooltip.Root key={product.id}>
                <Tooltip.Trigger asChild>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-gray-700">{formatPct(product.cagr_1y)}</td>
                    <td className="px-4 py-3 text-gray-700">{formatPct(product.cagr_3y)}</td>
                    <td className="px-4 py-3 text-gray-700">{formatPct(product.cagr_5y)}</td>
                    <td className="bg-blue-50 px-4 py-3 font-semibold text-blue-800">
